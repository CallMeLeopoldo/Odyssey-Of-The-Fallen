...
sprites.ebtn = love.graphics.newImage("images/EButton.png")
...
sprites.neutralface = love.graphics.newImage("images/neutralface.png")
sprites.badface = love.graphics.newImage("images/badface.png")
